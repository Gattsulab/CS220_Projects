...
def ternary_search_randomized_rec(arr, key, l, r):
    if r >= l:
        ...
        if arr[mid1] == key:
            ...
            return ternary_search_randomized_rec(arr, key, mid1 + 1, mid2 - 1)  # second part
    return -1
...
# [7] Add code to plot the timings for the algorithms
...
# works to test several types of algos
def run_algs(algs, sizes, trials):
    ...
    for size in sizes:
        ...
        for trial in range(1, trials + 1):  # runs several trials to be sure it isnt luck it runs well first try
            ...
            for alg in algs:
                ...
                dict_algs[alg.__name__][size] += 1000 * net_time  # time is in seconds and we turn it to micro seconds
    return dict_algs
...
def main():
    ...
    searches = [native_search, linear_search, linear_search_sentinel,
                ...
                ternary_search_iterative, ternary_search_recursive, ternary_search_randomized, exponential_search,
                jump_search, fibonacci_search, interpolation_search]
    trials = 1000
